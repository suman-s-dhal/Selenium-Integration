...
public class AssetsPage extends TestBase{
  ...
  //Filter
	...
	//	public static WebElement SearchTag;
		...
		@FindBy(xpath = "//*[@id=\"step7\"]/div[1]/div/div[2]/div/div")
	...
	/*	@FindBy(xpath = "")
		...
		@FindBy(xpath = "//button[@class='ant-btn sc-pkjoF EEQOa ant-btn-primary ant-btn-lg']")
...
//		public static WebElement ;
		...
		@FindBy(xpath = "//div[@class='AssignmentContainer']//button[@class='ant-btn ant-btn-ant-btn ant-btn-lg ant-btn-primary']")
		public static WebElement FinishCourse;
		
		@FindBy(xpath = "/html/body/div[8]/div/div[2]/div/div/div[2]/div[1]/div/div[1]/div[2]/div/div/div/div[1]/div[3]")
...
/*	public static void AddCreateQuiz() {
		AddClickQuiz.click();
		AddEnterQuizTitle.sendKeys("New Quiz");
		AddQuizQuetsions.sendKeys("/home/narmadha/Downloads/sample_quiz.txt");
